...
const Availability = () => {
  ...
  useEffect(() => {
    ...
    bindCountry()
      ...
      Axios.get(`${REACT_APP.API_URL}/api/TutorAvailQue/GetTutorAvail/${JSON.parse(localStorage.getItem('userData')).regid}`, {
          headers: {
              ApiKey: `${REACT_APP.API_KEY}`
          }
      })
                ...
                // console.log(values)
                  if(verifySts === 2){
                      ...
                      if(tutorcnt !== 0) {
                          ...
                          await Axios.put(`${REACT_APP.API_URL}/api/TutorAvailQue/UpdateTutorAvailQue`, values, {
                              headers: {
                                  ApiKey: `${REACT_APP.API_KEY}`
                              }
                          }).then(res => {
                          ...
                          await Axios.post(`${REACT_APP.API_URL}/api/TutorAvailQue/InsertTutorAvailQue`, values, {
                              headers: {
                                  ApiKey: `${REACT_APP.API_KEY}`
                              }
                          }).then(res => {
