...
const CourseLesson = () => {
    ...
    const handleSepActivityPage = (aqid) => {
        ...
        Axios.get(`${REACT_APP.API_URL}/api/activityQue/GetActivityQueListSeparateViewActivity/${EncryptData(aqid)}/${regid['regid']}/${cid}`, {
            headers: {
    ...
    useEffect(() => {
        ...
        if (localStorage.getItem('userData')) {
            ...
            setRegid(udata)
        // console.log(cid)
        Axios.get(`${REACT_APP.API_URL}/api/section/GetSectionLessionData/${acid}/${mid}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
            .then(res => {
                ...
                if (res.data) {
                    ...
                    Axios.get(`${REACT_APP.API_URL}/api/lession/GetLessionAtid/${EncryptData(lsn[0]['nLId'])}`, {
                        headers: {
                            ApiKey: `${REACT_APP.API_KEY}`
                        }
                    })
                    ...
                    Axios.get(`${REACT_APP.API_URL}/api/tutorialDocument/GetTutorialDocumentBatch/${EncryptData(lsn[0]['nLId'])}`, {
                        headers: {
                            ApiKey: `${REACT_APP.API_KEY}`
                        }
                    })
                    ...
                    Axios.get(`${REACT_APP.API_URL}/api/tutorialDocument/GetTutorialCourseOverview/${EncryptData(lsn[0]['nLId'])}`, {
                        headers: {
                            ApiKey: `${REACT_APP.API_KEY}`
                        }
                    })
                    ...
                    Axios.get(`${REACT_APP.API_URL}/api/activityMember/GetActivityQueTypeMemAct/${EncryptData(lsn[0]['nLId'])}/${udata['regid']}/${cid}`, {
                        headers: {
                            ApiKey: `${REACT_APP.API_KEY}`
                        }
                    })
        ...
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetCourseName/${cid}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
        ...
        Axios.get(`${REACT_APP.API_URL}/api/activityQue/GetActivityQueListSeparateViewActivity/q0n35b7QFQwkemlkqZeYlA==/NcaRT9myjUShi4YozcspTQ==/qOr2fmJ-rEL28x8SQMolTA==`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
