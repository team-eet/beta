          ...
          if (res.data.length !== 0) {
            ...
            if (maximumItemCart >= (cartitemcnt + 1)) {
              ...
              if(localStorage.getItem('userData')) {
                ...
                Axios.get(`${REACT_APP.API_URL}/api/promocode/Get_promocode_detail/${EncryptData(id)}/${udata['regid']}/${EncryptData(getamt)}`, {
                  headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                  }
                })
                ...
                <div className="row g-5">
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="read-more-btn mt--40 ms-2">
                      <a className="rbt-moderbt-btn" href="/all-course">
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="read-more-btn mt--40 ms-3">
                      <a className="rbt-moderbt-btn" href="/all-batch">
          ...
          <div className={'row'}>
            ...
            <div className={'col-lg-4 col-md-12 h-100 mt-3'}>
              <div className="rbt-service rbt-service-2 rbt-hover-02 bg-no-shadow card-bg-3">
                <div className="inner">
                  <div className="content">
                    <h4 className="title"><a href="#">Be a Partener</a></h4>
