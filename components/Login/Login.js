...
import { SuccessProgressToast, ErrorMessageToast, ErrorAlert } from "@/components/services/Toast";
          ...
          <div className="rbt-contact-form contact-form-style-1 max-width-auto">
            ...
            <Formik
                ...
                initialValues={{
                  ...
                  // password: localStorage.getItem('password') ? DecryptData(localStorage.getItem('password')) : ''
                }}
                    ...
                    if (res.data) {
                      ...
                      if (retData.ulogin) {
                        if (retData.success === "1") {
                          ...
                          Axios.post(`${REACT_APP.API_URL}/api/notification/InsertNotificationHistory`, notificationdata, {
                            headers: {
                              ApiKey: `${REACT_APP.API_KEY}`
                            }
                          }).then(res => {
                  ...
                  <div className='auth-wrapper auth-v2'>
                    ...
                    <Form className='auth-login-form mt-2'>
                      ...
                      <FormGroup className='input-group input-group-merge mb-0'>
                        ...
                        <Field name="password" type={fieldtype} size={'sm'}
                        ...
                        <div className="input-group-append">
                          <div className="input-group-text h-100">
                            <Link onClick={handleChangePsw} href='#'>
                      ...
                      <FormGroup>
                        <button className="rbt-btn btn-md btn-gradient hover-icon-reverse w-100" color='primary' type='submit' disabled={isLoading}>
                          {isLoading ? <div>
