...
const Reciept = () => {
    ...
    useEffect(() => {
        ...
        if(localStorage.getItem('userData')){
            ...
            Axios.get(`${REACT_APP.API_URL}/api/registration/GetUserProfile/${udata['regid']}`, {
                headers: {
            ...
            Axios.get(`${REACT_APP.API_URL}/api/myOrder/GetOrderData/${udata['regid']}/${currentOrderId}`, {
                headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                }
            })
            ...
            Axios.get(`${REACT_APP.API_URL}/api/myOrder/GetOrderItem/${udata['regid']}`, {
                headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                }
            })
                                ...
                                <div className='pb-0'>
                                    <div className='d-flex justify-content-between flex-md-row flex-column mt-0 mb-3'>
                                        ...
                                        <div className='mt-md-0 mt-2' style={{ fontSize: '15px' }}>
                                            ...
                                            <div className=''>
                                                <span className='font-weight-bolder'>Order : </span> <span className='invoice-number'>#{DecryptData(orderId)}</span>
                                            </div>
