...
const Setting = () => {
  ...
  useEffect(() => {
    ...
    if(localStorage.getItem('userData')){
      ...
      Axios.get(`${REACT_APP.API_URL}/api/registration/FillUserProfile/${udata['regid']}`, {
        headers: {
          ApiKey: `${REACT_APP.API_KEY}`
        }
      })
          ...
          <div className="tab-content">
              ...
              <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    ...
                    if (values.sFName && values.sLName) {
                      ...
                      await Axios.put(`${REACT_APP.API_URL}/api/registration/UpdateProfileGeneral`, values, {
                        headers: {
                          ApiKey: `${REACT_APP.API_KEY}`
                        }
                      }).then(res => {
                          ...
                          <div className="rbt-tutor-information-left">
                            <div className="thumbnail rbt-avatars size-lg position-relative">
                              ...
                              <div className="rbt-edit-photo-inner">
                                {/*<button className="rbt-edit-photo" onChange={onChangeImage} title="Upload Photo">*/}
              ...
              <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    ...
                    if(values.sPassword) {
                      ...
                      await Axios.put(`${REACT_APP.API_URL}/api/registration/PasswordChange`, values, {
                        headers: {
                          ApiKey: `${REACT_APP.API_KEY}`
                        }
                      }).then(res => {
            ...
            >
              <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    // console.log(values)
                      await Axios.put(`${REACT_APP.API_URL}/api/registration/UpdateProfilePersonal`, values, {
                        headers: {
                          ApiKey: `${REACT_APP.API_KEY}`
                        }
                      }).then(res => {
              ...
              <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    console.log(values)
                      ...
                      await Axios.put(`${REACT_APP.API_URL}/api/registration/UpdateProfileSocialLink`, values, {
                        headers: {
                          ApiKey: `${REACT_APP.API_KEY}`
                        }
                      }).then(res => {
