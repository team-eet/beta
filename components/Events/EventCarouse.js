...
const EventCarouse = () => {
  ...
  const getCourse = () => {
    let upc_chk = false
    Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetUpcomingCoursesMem/2`, {
      headers: {
                  ...
                  <SwiperSlide className="swiper-wrapper" key={index}>
                    <div className="swiper-slide">
                      <div className="single-slide">
                        <div className="rbt-card event-grid-card variation-01 rbt-hover">
                          <div className="rbt-card-img">
                            <Link href={`/event-details/${data.nCId}`}>
                              <img
                                  src={data.sImagePath}
                                  width={710}
                                  height={480}
                          ...
                          <div className="rbt-card-body">
                            <ul className="rbt-meta">
                              <li>
                                <i className="feather-map-pin"></i> {data.sUpcomingDate}
                              </li>
                              <li>
