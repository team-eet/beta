...
const AllCourses = () => {
    ...
    // const handleChangeCategory = (e, ccid) => {
    //     console.log(ccid)
    //     setCatid(ccid)
    //
    //     if (e.target.checked) {
    //         // setCatid([...CatId, ccid])
    //         setCatid([...ccid])
    //         console.log(JSON.stringify([ccid]))
    //         // setCatid((state) => {
    //         //     [...state.nCCId, ccid]
    //         // })
    //         Axios.get(`${REACT_APP.API_URL}/api/coursemain/CategoryCourseMultiple/${JSON.stringify([ccid])}`, {
    //             headers: {
    //                 ApiKey: `${REACT_APP.API_KEY}`
    //             }
    //         })
    ...
    //                 console.log(res.data)
    //                 if (res.data.length !== 0) {
    //                     console.log('CategoryCourseMultiple', res.data)
    //                     // setcourseData([])
    //                     // setcourseData(res.data)
    //
    //                 } else {
    ...
    //     } else {
    //         const array = [CatId]
    //         const index = array.indexOf(ccid)
    //         if (index !== -1) {
    ...
    const [setCCid, setSetCCid] = useState('');
    ...
    const handleChangeCategory = (e, ccid) => {
        ...
        if (e.target.checked) {
            setNCCId(prevNCCId => [...prevNCCId, ccid]);
            console.log(JSON.stringify(nCCId))
            Axios.get(`${REACT_APP.API_URL}/api/coursemain/CategoryCourseMultiple/${JSON.stringify(nCCId)}`, {
                headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                }
            })
            ...
            setNCCId(prevNCCId => prevNCCId.filter(id => id !== ccid));
            Axios.get(`${REACT_APP.API_URL}/api/coursemain/CategoryCourseMultiple/${JSON.stringify(nCCId)}`, {
                headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                }
    ...
    const handleChangeLevel = (e, clid) => {
        ...
        if (e.target.checked) {
            setNCLId(prevNCLId => {
                ...
                Axios.get(`${process.env.REACT_APP_API_URL}/api/coursemain/LevelCourseMultiple/${JSON.stringify(nCLId)}`, {
                    headers: {
    ...
    const handleChangePrice = (e, cpid) => {
        ...
        if (e.target.checked) {
            setNCPId(prevNCPId => {
                ...
                Axios.get(`${process.env.REACT_APP_API_URL}/api/coursemain/PriceCourseMultiple/${JSON.stringify(nCPId)}`, {
                    headers: {
                        ApiKey: `${process.env.REACT_APP_API_KEY}`
                    }
                })
   ...
   // const handlePriceCourse = (hl, e) => {
   //     setcpricename(e.currentTarget.textContent)
   //      // this.setState({
   //      //     cpricename: e.currentTarget.textContent
   //      // })
   //      if (hl) {
   //          Axios.get(`${REACT_APP.API_URL}/api/package/GetCoursePricewise/${this.props.match.params.ccid}/${hl}`, {
   //              headers: {
   //                  ApiKey: `${REACT_APP.API_KEY}`
   //              }
   //          })
                                        ...
                                        <div className="rbt-short-item">
                                            <div className="filter-select">
                                                ...
                                                <div className="filter-select rbt-modern-select search-by-category">
                                                    <select>
                                                        <option onSelect={(e) => handlePriceCourse('lowest', e)} value={"lowest"}>Lowest</option>
                                                        <option onSelect={(e) => handlePriceCourse('highest', e)} value={"highest"}>Highest</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
