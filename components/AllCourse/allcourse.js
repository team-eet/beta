...
const AllCoursetwo = () => {
    ...
    const handleShortBy = (e) => {
        ...
        if (e.target.value === 'L') {
            ...
            Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetCoursesMem/2/L/${category}/${level}/${searchvalue}/${price}`, {
                headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                }
            })
            ...
            setcourseData([])
            console.log('H')
            Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetCoursesMem/2/H/${category}/${level}/${searchvalue}/${price}`, {
                headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                }
            })
    ...
    console.log(categoryId, categoryParam, levelId);
        ...
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetCoursesMem/2/L/${EncryptData(categoryParam)}/${level}/${searchvalue}/${price}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
                                                                        ...
                                                                        <div className="rbt-card-body">
                                                                            <div className="rbt-card-top">
                                                                                ...
                                                                                <div className="rbt-bookmark-btn">
                                                                                    <a className="rbt-round-btn"
                                                                                       title="Bookmark"
                                                                                       href="#"><i
                                                                                        className="feather-heart"></i></a>
                                                                                </div>
                                                                            </div>
