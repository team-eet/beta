...
const AllCoursetwo = () => {
    ...
    console.log(categoryId, categoryParam, levelId);
        ...
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetCoursesMem/2/L/${EncryptData(categoryParam)}/${level}/""/${price}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
    ...
    const handleChangeLevel = (clid) => {
        ...
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetCoursesMem/2/L/${category}/${level}/""/${price}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
