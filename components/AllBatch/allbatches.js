...
const AllBatches = () => {
    ...
    const bindCourseCategory = () => {
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetBatchWiseCategory`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
    ...
    const onTutorchange = (e) => {
        ...
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetBatchCoursesMem/0/${categoryId}/${e.target.value}/${shortBy}/${searchBy}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
    ...
    const onCategoryChange = (e) => {
        ...
        Axios.get(`${REACT_APP.API_URL}/api/coursemain/GetBatchCoursesMem/2/${e.target.value}/${tutorid}/${shortby}/${searchby}`, {
            headers: {
                ApiKey: `${REACT_APP.API_KEY}`
            }
        })
                                            ...
                                            <div className="filter-select rbt-modern-select">
                                                ...
                                                <select onChange={onTutorchange}>
                                                    {gettutorList.map((data, index) => {
                                                        ...
                                                        return(
                                                            <>
                                                                <option key={index} value={data.nCreatedBy}>{data.sFName} {data.sLName}</option>
                                                            </>
                                                        )
                                                    })
                                                    }
