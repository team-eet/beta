...
const Viedo = ({ checkMatchCourses }) => {
  ...
  //     //activity
       Axios.get(`${REACT_APP.API_URL}/api/package/Show_activity_count/${courseId}`, {
        headers: {
  ...
  //
  //     //video
      Axios.get(`${REACT_APP.API_URL}/api/package/Show_video_count/${courseId}`, {
        headers: {
           ApiKey: `${REACT_APP.API_KEY}`
        }
      })
  ...
  //     //pdf
      Axios.get(`${REACT_APP.API_URL}/api/package/Show_pdf_count/${courseId}`, {
        headers: {
           ApiKey: `${REACT_APP.API_KEY}`
        }
      })
  ...
  //     //image
      Axios.get(`${REACT_APP.API_URL}/api/package/Show_image_count/${courseId}`, {
        headers: {
           ApiKey: `${REACT_APP.API_KEY}`
        }
      })
          ...
          if (res.data.length !== 0) {
            ...
            if (maximumItemCart >= (cartitemcnt + 1)) {
              ...
              if(localStorage.getItem('userData')) {
                ...
                Axios.get(`${REACT_APP.API_URL}/api/promocode/Get_promocode_detail/${courseId}/${udata['regid']}/${EncryptData(getamt)}`, {
                  headers: {
                    ApiKey: `${REACT_APP.API_KEY}`
                  }
                })
